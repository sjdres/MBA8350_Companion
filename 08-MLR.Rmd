...
```{r, echo = FALSE}
REG2 <- lm(price ~ sqrft + bdrms + lotsize, data = hprice1)
pander(summary(REG2))
```
...
$$H_0: \beta_1 = 0 \quad versus \quad \beta_1 \neq 0$$
...
$$H_0: \beta_1 \geq 0.125 \quad versus \quad \beta_1 < 0.125$$
