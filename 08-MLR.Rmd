...
Note that our dataset already has a variable called month which identifies 1 as January, 2 an February, etc. This will make the creation of dummy variables very easy.
